...
let columnStyles={
	...
	audioports:							{title:"Audio",				headerTooltip:'Audio Ports',			sorter: 'string', width:80, hozAlign:"left" },
	...
	devicepage:							{title:"Page",				headerTooltip:'Device Page',			formatter: FormatterLinkDevice, sorter: 'string', tooltip:false, width:50 },
	...
	fccid:								{title:"FCC",				headerTooltip:'FCC ID',					formatter: FormatterLink, formatterParams:{ label:'FCC'},		sorter: 'string', width:40 },
	firmwareoemstockurl:				{title:"Stock",				headerTooltip:'OEM Stock Firmware',		formatter: FormatterLink, formatterParams:{ label:'Stock'},		sorter: 'string', width:50 },
	firmwareopenwrtinstallurl:			{title:"Install",			headerTooltip:'Owrt Firmware Install',	formatter: FormatterLink, formatterParams:{ label:'Inst.'},		sorter: 'string', width:50 },
	firmwareopenwrtupgradeurl:			{title:"Upgrade",			headerTooltip:'Owrt Firmware Upgrade',	formatter: FormatterLink, formatterParams:{ label:'Upgr.'}, 	sorter: 'string', width:55 },
	firmwareopenwrtsnapshotinstallurl:	{title:"Snap.Inst.",		headerTooltip:'Owrt Snapshot Install',	formatter: FormatterLink, formatterParams:{ label:'Sn.Inst.'},	sorter: 'string', width:70 },
	firmwareopenwrtsnapshotupgradeurl:	{title:"Snap.Upgr.",		headerTooltip:'Owrt Snapshot Upgrade',	formatter: FormatterLink, formatterParams:{ label:'Sn.Upgr.'},	sorter: 'string', width:70 },
	...
	forumsearch:						{title:"Forum Search",		headerTooltip:'Forum Search', 			sorter: 'string', width:90, hozAlign:"left" },
	gitsearch:							{title:"Git Search",		headerTooltip:'Git Search',				sorter: 'string', width:90, hozAlign:"left" },
	gpios:								{title:"GPIOs",				headerTooltip:'GPIOs',					formatter: FormatterCleanWords, width:40, ...colFilterMin },
	installationmethods:				{title:"Inst.Method",		headerTooltip:'Installation method(s)', sorter: 'string', width:90, hozAlign:"left" },
	...
	oemdevicehomepageurl:				{title:"OEM",				headerTooltip:'OEM Page',				formatter: FormatterLink, formatterParams:{ label:'OEM'}, 	sorter: 'string', width:45 },
	outdoor:							{title:"OutDoor",													formatter: FormatterYesNo, sorter: 'string', 				width:40 },
	owrt_forum_topic_url:				{title:"Forum",				headerTooltip:'Forum Topic',			formatter: FormatterLink, formatterParams:{ label:'Forum'}, sorter: 'string', width:55 },
	packagearchitecture:				{title:"Pkg Arch",			headerTooltip:'Package Architecture',	width:90, hozAlign:"left" },
	phoneports:							{title:"Phone",				headerTooltip:'Phone Ports',			sorter: 'string', width:40 },
	...
	sfp_ports:							{title:"SFTP",				headerTooltip:'SFTP Ports', 			sorter: 'string', width:40, ...colFilterMin},
	...
	usbports:							{title:"USB",				headerTooltip:'USB Ports', 				sorter: 'string', width:60, hozAlign:"left", ...colFilterMin },
	version:							{title:"Version",			headerTooltip:'Hardware Version', 		width:55, hozAlign:"left" },
	videoports:							{title:"Video",				headerTooltip:'Video Ports', 			sorter: 'string', width:80, hozAlign:"left" },
	...
	wlandriver:							{title:"WLAN Driver",		headerTooltip:'WLAN Driver', 			sorter: 'string', width:80, hozAlign:"left" },
	...
	wlan60ghz:							{title:"6.0Ghz",			headerTooltip:'WLAN 60 Ghz', 			sorter: 'string', width:60, hozAlign:"left" },
	wlan600ghz:							{title:"200Ghz",			headerTooltip:'WLAN 600 Ghz', 			sorter: 'string', width:60, hozAlign:"left" },
	...
	wikideviurl:						{title:"Wiki",				headerTooltip:'Wiki Page',				formatter: FormatterLink, formatterParams:{ label:'Wiki'}, sorter: 'string', width:40 },
};
