...
//	|toh field,							|Col Name				|Full Name										|width		|Horinzontal Align	|sorter type		|stay left		|formatter						|formatterParams				|misc options
	...
	fccid:								{title: "FCC",			headerTooltip: 'FCC ID',						width: 35,	hozAlign: 'left',	sorter: 'string',	frozen: false,	formatter: FormatterLink,		formatterParams: {label: 'FCC'}},
	firmwareoemstockurl:				{title: "Stock",		headerTooltip: 'OEM Stock Firmware',			width: 45,	hozAlign: 'left',	sorter: 'string',	frozen: false,	formatter: FormatterLink,		formatterParams: {label: 'Stock'}},
	firmwareopenwrtinstallurl:			{title: "Install",		headerTooltip: 'OpenWrt Firmware Install',		width: 45,	hozAlign: 'left',	sorter: 'string',	frozen: false,	formatter: FormatterLink,		formatterParams: {label: 'Inst.'}},
	firmwareopenwrtupgradeurl:			{title: "Upgrade",		headerTooltip: 'OpenWrt Firmware Upgrade',		width: 59,	hozAlign: 'left',	sorter: 'string',	frozen: false,	formatter: FormatterLink,		formatterParams: {label: 'Upgr.'}},
	firmwareopenwrtsnapshotinstallurl:	{title: "Snap.Inst.",	headerTooltip: 'OpenWrt Snapshot Install',		width: 65,	hozAlign: 'left',	sorter: 'string',	frozen: false,	formatter: FormatterLink,		formatterParams: {label: 'Sn.Inst.'}},
	firmwareopenwrtsnapshotupgradeurl:	{title: "Snap.Upgr.",	headerTooltip: 'OpenWrt Snapshot Upgrade',		width: 70,	hozAlign: 'left',	sorter: 'string',	frozen: false,	formatter: FormatterLink,		formatterParams: {label: 'Sn.Upgr.'}},
	...
	oemdevicehomepageurl:				{title: "OEM",			headerTooltip: 'OEM Page',						width: 45,	hozAlign: 'left',	sorter: 'string',	frozen: false,	formatter: FormatterLink,		formatterParams: {label: 'OEM'}},
	...
	owrt_forum_topic_url:				{title: "Forum",		headerTooltip: 'Forum Topic',					width: 50,	hozAlign: 'left',	sorter: 'string',	frozen: false,	formatter: FormatterLink,		formatterParams: {label: 'Forum'}},
	...
	wikideviurl:						{title: "Wiki",			headerTooltip: 'Wiki Page',						width: 40,	hozAlign: 'left',	sorter: 'string',	frozen: false,	formatter: FormatterLink,		formatterParams: {label: 'Wiki'}},
